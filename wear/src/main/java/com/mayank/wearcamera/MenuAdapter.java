...
public class MenuAdapter extends FragmentGridPagerAdapter {
    ...
    int[] currentFlashText = { com.mayank.wearcamera.R.string.action_flash_0, com.mayank.wearcamera.R.string.action_flash_1, com.mayank.wearcamera.R.string.action_flash_2 };
    int[] currentFlashIcon = { com.mayank.wearcamera.R.drawable.action_flash_0, com.mayank.wearcamera.R.drawable.action_flash_1, com.mayank.wearcamera.R.drawable.action_flash_2 };

    private static int currentCamera = 0;
    int[] currentCameraText = { com.mayank.wearcamera.R.string.action_switch_0, com.mayank.wearcamera.R.string.action_switch_1 };
    int[] currentCameraIcon = { com.mayank.wearcamera.R.drawable.action_switch_0, com.mayank.wearcamera.R.drawable.action_switch_1 };

    private static int currentTimer = 0;
    int[] currentTimerText = { com.mayank.wearcamera.R.string.action_timer_0, com.mayank.wearcamera.R.string.action_timer_1, com.mayank.wearcamera.R.string.action_timer_2 };
    int[] currentTimerIcon = { com.mayank.wearcamera.R.drawable.action_timer_0, com.mayank.wearcamera.R.drawable.action_timer_1, com.mayank.wearcamera.R.drawable.action_timer_2 };
